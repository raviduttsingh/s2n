...
const char tls13_cert_chain_hex[] =
    "0001b03082" /* without chertificate size */
    "01ac30820115a003020102020102300d06092a8648"
    "86f70d01010b0500300e310c300a06035504031303"
    "727361301e170d3136303733303031323335395a17"
    "0d3236303733303031323335395a300e310c300a06"
...
const char tls13_cert_chain_size_hex[] =
     "0001b03082"; /* certificate size */
...
int main(int argc, char **argv)
{
    ...
    /* Test s2n_server_cert_send() verify certificate request context */
    {
        S2N_BLOB_FROM_HEX(tls13_cert_chain, tls13_cert_chain_hex);
        S2N_BLOB_FROM_HEX(tls13_cert_chain_size, tls13_cert_chain_size_hex);
        ...
        /* certificate request context for server should always be zero */
        EXPECT_EQUAL(certificate_request_context, 0);
        EXPECT_SUCCESS(s2n_connection_free(conn));
    }
